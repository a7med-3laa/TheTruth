...
public class UserAsyncTask extends AsyncTask<String, Void, List<User>> {
    ...
    public AsyncTask<String, Void, List<User>> executeTask(String search) {
        return this.execute("https://us-central1-thetruth-9b237.cloudfunctions.net/search?name=" + search);
    }
